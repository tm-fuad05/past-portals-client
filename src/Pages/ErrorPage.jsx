...
const ErrorPage = () => {
  return (
    <div className="boxShadow px-10 w-full lg:flex-row gap-[30px] lg:gap-0 flex-col flex items-center justify-evenly py-20 rounded-xl">
      ...
      <div className="w-full flex flex-col gap-5 lg:w-[30%] text-center lg:text-start">
        ...
        <div>
          <a
            href="/"
            className="py-3 px-6 sm:px-8 text-[0.9rem] sm:text-[1rem] rounded-full bg-[#566FA7] text-white mt-10 hover:opacity-60"
          >
            Back to homepage
          </a>
        </div>
